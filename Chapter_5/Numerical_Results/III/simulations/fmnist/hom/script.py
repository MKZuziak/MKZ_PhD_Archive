...
from model import create_FashionMnistNet
...
def simulation():
    ...
    with open(f'/home/maciejzuziak/Uniform_Contribution_Paper-1/PhD_experiments/III/datasets/fmnist/hom/FMNIST_10_dataset_pointers', 'rb') as file:
